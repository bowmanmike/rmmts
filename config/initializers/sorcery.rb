...
Rails.application.config.sorcery.submodules = [:reset_password, :user_activation, :remember_me, :activity_logging]
...
Rails.application.config.sorcery.configure do |config|
  ...
  config.user_config do |user|
    ...
    # Default: `nil`
    #
    user.user_activation_mailer = MateMailer
    ...
    # Default: `nil`
    #
    user.reset_password_mailer = MateMailer
